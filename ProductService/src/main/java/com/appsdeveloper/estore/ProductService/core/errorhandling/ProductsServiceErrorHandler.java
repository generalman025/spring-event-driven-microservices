package com.appsdeveloper.estore.ProductService.core.errorhandling;
...
public class ProductsServiceErrorHandler {
	...
	public ResponseEntity<Object> handlerIllegalStateException(IllegalStateException ex, WebRequest request){
